...
begin
  ...
  Jeweler::Tasks.new do |gem|
    gem.name = "gdata"
    gem.summary = %Q{Google Data APIs Ruby Utility Library}
    gem.description = %Q{This gem provides a set of wrappers designed to make it easy to work with the Google Data APIs.}
    gem.email = "trevorjohns@google.com"
    gem.homepage = "http://code.google.com/p/gdata-ruby-util"
    gem.authors = ['Jeff Fisher','Trevor Johns']
    gem.version = '1.1.2'
  end
